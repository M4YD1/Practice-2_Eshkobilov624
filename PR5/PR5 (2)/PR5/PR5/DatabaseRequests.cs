...
public static class DatabaseRequests
{
    ...
    public static void GetCarQuery()
    {
        ...
        while (reader.Read())
        {
            Console.WriteLine($"Id: {reader[0]} Id Типа автомобиля: {reader[1]} Название: {reader[2]} Государственный номер: {reader[3]} " +
                              $"Количество пассажиров: {reader[4]}");
        }
    }
    ...
    public static void GetRouteQuery()
    {
        ...
        while (reader.Read())
        {
            Console.WriteLine($"Id: {reader[0]} Id Водителя: {reader[1]} Id Автомобиля: {reader[2]} Id Маршрута: {reader[3]} " +
                              $"Количество пассажиров: {reader[4]}");
        }
    }
    ...
    public static void GetDriverRightsCategoryQuery(int driver1)
    {
